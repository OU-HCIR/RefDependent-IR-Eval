...
"""
print("generate ref t feature for Session2014")
...
Session_2014.to_csv('data/data_with_refer_feature/Session_2014_refer_t.csv', index=False)
"""
=================================================================================================
Session_2013
=================================================================================================
"""
print("generate ref t feature for Session2013")
...
Session_2013.to_csv('data/data_with_refer_feature/Session_2013_refer_t.csv', index=False)
"""
================================================================================================
THU-KDD19
================================================================================================
...
THU_KDD19_base_cols = ['QueryLength', 'QueryDwellTime', 'NewTerm', 'QuerySim',
                       ...
                       'AveTaskRelScore', 'NewTerm', 'QuerySim', 'ClickDepth', 'ActionCount',
...
"""
print("generate ref t feature for THU-KDD19")
...
THU_KDD19.to_csv('data/data_with_refer_feature/THU_KDD19_refer_t.csv', index=False)
...
reference_cols_t.to_csv('data/data_with_refer_feature/reference_cols_t.csv', index=False)